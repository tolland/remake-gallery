...
var _data, _form, _error, _params, _route, _state, _status, _url, _a, _current, _b, _current2, _c;
import { o as onMount, s as svelte } from "./ni0L-ZnL.js";
import { x as noop$1, bc as safe_not_equal, ac as state, F as get$1, ah as set$1, t as tick$1 } from "./CrzjONjd.js";
import { a as assets, b as base } from "./BZ1NIW7A.js";
...
if (is_legacy) {
  ...
  }, _data = new WeakMap(), _form = new WeakMap(), _error = new WeakMap(), _params = new WeakMap(), _route = new WeakMap(), _state = new WeakMap(), _status = new WeakMap(), _url = new WeakMap(), _a)();
  navigating = new (_b = class {
    constructor() {
  ...
  }, _current = new WeakMap(), _b)();
  updated = new (_c = class {
    constructor() {
...
async function start(_app, _target, hydrate) {
  ...
  if ((_a2 = globalThis.__sveltekit_1nr4ugs) == null ? void 0 : _a2.data) {
    globalThis.__sveltekit_1nr4ugs.data;
  }
  ...
  current_history_index = (_d = history.state) == null ? void 0 : _d[HISTORY_INDEX];
  current_navigation_index = (_e = history.state) == null ? void 0 : _e[NAVIGATION_INDEX];
...
//# sourceMappingURL=DzTkw2I9.js.map
